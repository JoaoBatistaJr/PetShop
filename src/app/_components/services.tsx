...
const services = [
  {
    title: "Banho & Tosa",
    description: "Inclui banho com projdutos específicos para o tipo de pelagem e pele do animal, corte unhas, limpeza das orelhas e tosa personalizada (higiênica ou estilizada).",
    duration: "1h",
    price: "$50",
    icon: <Scissors />,
  ...
  {
    title: "Consulta Venerinária",
    description: "Oferecemos atendimento clínico básico ou especializado para cuidar da saúde do animal. Inclui diagnóstico de doenças, aplicação de vacinas obrigatórias.",
    duration: "1h",
    price: "$45",
    icon: <Syringe />,
  ...
  {
    title: "Táxi Pet",
    description: "Servioço de transporte para levar e buscar os pets no petshop, clínicas veterinárias ou outros locais. Ideal para tutores que não têm tempo ou transporte para locomover os animais.",
    duration: "2h",
    price: "$80",
    icon: <CarTaxiFront />,
                ...
                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                  <article className="bg-[#1E293B] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a target='_blank'
                        href={`https://wa.me/55987369216?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`} className="flex items-center justify-center gap-2 hover:bg-red-500 px-4 py-1 rounded-md duration-300">
